  ...
  variables: [
    {
      ...
      value: function (md) {
        return md`
# Helical Wheel Visualization (WIP 2019_05_31)
        `;
      },
    },
    {
      ...
      value: function (md) {
        return md`
Check out our pretty website at [http://clemlab.github.io/helicalwheel/](http://clemlab.github.io/helicalwheel/)!
The purpose of this notebook is to plot helical wheel diagrams with many options. For more information about helical wheel diagrams, see [https://en.wikipedia.org/wiki/Helical_wheel](https://en.wikipedia.org/wiki/Helical_wheel). It may take a long time to load, and using the website linked above to create diagrams is recommended.
Recommended Browser: Chrome
    ...
    },
    {
      ...
      value: function (DOM, serialize, chart) {
